              ...
              <li class="participant-item">
                ...
                >
                  <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                    <path d="M9 3h6l1 2h4v2H4V5h4l1-2zm1 7v8h2v-8h-2zm4 0v8h2v-8h-2zM7 10v8h2v-8H7z" />
                  </svg>
                </button>
              </li>
            `
  ...
  signupForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Immediate local update for better UX, then refresh from API source-of-truth.
        if (latestActivities[activity] && !latestActivities[activity].participants.includes(email)) {
          latestActivities[activity].participants.push(email);
        }
